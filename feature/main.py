...
def get_feat(train, sample):
    ...
    result = get_user_eloc_distance_stat(train,
                                         result)  # user_eloc_dis_max, user_eloc_dis_min, user_eloc_dis_med # dui 90 wc
    result = get_user_sloc_distance_stat(train,
                                         result)  # user_sloc_dis_min, user_sloc_dis_max, user_sloc_dis_med # dui 90 wc
    ...
    # 删除无用特征 result.drop(['sloc_lon_sub_max', 'user_hour_distance_mean', 'user_sloc_distance_mean',
    # 'user_eloc_hour_max', 'sloc_lat_sub_max', 'eloc_bike_last_sloc_distance', 'hour', 'eloc_bike_last_sloc_speed',
    # 'user_eloc_hour_min', 'eloc_hour_count', 'user_lon_sub_max', 'eloc_hour_lon_sub_max', 'user_hour_max',
    # 'user_lat_sub_max', 'eloc_hour_lat_sub_min', 'hour_count', 'eloc_hour_lat_sub_max', 'eloc_hour_lon_sub_min',
    # 'user_eloc_distance_min', 'user_hour_count_rate', 'user_eloc_distance_mean', 'user_hour_min',
    # 'user_hour_eloc_rate', 'eloc_lon_sub_min', 'user_eloc_lon_sub_mean', 'user_eloc_lat_sub_mean',
    # 'user_eloc_hour_mean', 'user_eloc_lon_sub_min', 'user_eloc_lat_sub_min', 'user_eloc_lon_sub_max',
    # 'sloc_lat_sub_min', 'user_eloc_hour_count', 'eloc_lat_sub_min', 'user_eloc_count_rate', 'eloc_count_rate',
    # 'sloc_lon_sub_min', 'user_eloc_lat_sub_max', 'hour_count_rate', 'user_end_loc_sample', 'sloc_lat',
    # 'user_lat_sub_mean', 'sloc_lon', 'user_hour_distance_mean_sub', 'sloc_distance_max', 'user_lon_sub_mean',
    # 'user_distance_mean', 'sloc_distance_mean_sub_abs', 'user_sloc_distance_min', 'sloc_lat_sub_mean',
    # 'eloc_lon_sub_max', 'user_sloc_distance_max', 'eloc_distance_max', 'hour_user_hour_mean_sub',
    # 'eloc_as_sloc_count', 'sloc_distance_min', 'eloc_lat_sub_max', 'bike_next_sloc_sample', 'user_rule',
    # 'eloc_distance_mean_sub_abs', 'user_lat_sub_min', 'user_lon_sub_min', 'loc_to_loc_sample',
    # 'user_sloc_hour_distance_min', 'user_sloc_hour_distance_max', 'user_sloc_hour_distance_mean',
    # 'user_sloc_hour_distance_mean_sub', 'sloc_hour_count'], axis=1, inplace=True)
